...
const Header = () => {
    ...
    return (
        <div className='sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-black text-5xl'>
            {loading && <Loader />}
            ...
            <div className="flex justify-between h-5 items-center">
                ...
                <Link to={'/'}>
                    <img src={ytlogo} alt="Youtube" className='w-28 h-full dark:md:block' />
                    <img src={ytlogomobile} alt="Youtube" className='md:hidden h-full' />
                </Link>
            </div>
            <div className="group flex items-center">
                <div className="flex h-8 md:h-10 md:mr-10 md:pl-5 border border-[#303030] rounded-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0" >
                    <div className="w-10 px-1 items-center justtify-center md:hidden group-focus-within:md:flex">
                        <IoIosSearch className='text-white text-xl' />
                    </div>
                    <input type="text"
                        className='bg-transparent text-[16px] outline-none border-0 text-white pr-5 pl-5 md:pl-0 w-44 md:group-focus-within:pl-0 md:w-64 lg:w-[500px]'
